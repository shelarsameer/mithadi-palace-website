                    ...
                    <div className="flex flex-col gap-3 mt-auto">
                      ...
                      {variant && variant.availableForSale ? (
                        <Button 
                          ...
                          size="sm"
                          className="w-full bg-royal-gold hover:bg-royal-darkGold text-white px-3 md:px-6 py-2 md:py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 text-xs md:text-sm"
                        >
                          Add to Cart
                        </Button>
                      ) : (
