        ...
        {filteredProducts.length === 0 ? (
          ...
          <div className="grid grid-cols-2 sm:grid-cols-3 lg:grid-cols-4 xl:grid-cols-5 gap-4 md:gap-6">
            {filteredProducts.map((product) => {
              ...
              return (
                <div key={product.id} className="group bg-white rounded-xl md:rounded-2xl overflow-hidden shadow-lg hover:shadow-2xl transition-all duration-500 transform hover:-translate-y-2 flex flex-col">
                    ...
                    <div className="flex flex-col gap-3 mt-auto">
                      ...
                      {variant && variant.availableForSale ? (
                        <Button 
                          ...
                          size="sm"
                          className="bg-royal-gold hover:bg-royal-darkGold text-white px-3 md:px-6 py-2 md:py-3 rounded-full font-medium shadow-lg hover:shadow-xl transition-all duration-300 text-xs md:text-sm w-full"
                        >
                          Add to Cart
                        </Button>
                      ) : (
                        <Button disabled size="sm" className="rounded-full text-xs md:text-sm w-full">
                          Out of Stock
                        </Button>
                      )}
                    </div>
